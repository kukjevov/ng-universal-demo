                ...
                private _changeDetector: ChangeDetectorRef)
{
    ...
    public async ngOnChanges(changes: SimpleChanges)
    {
        if(nameof<LayoutDesignerComponent>('rootComponentMetadata') in changes && this.rootComponentMetadata)
        {
            ...
            const designerMetadata = await this._packageLoader.getComponentsMetadata(this.rootComponentMetadata.componentPackage, this.rootComponentMetadata.componentName);
    ...
    {
        const dragItem = this._dragSvc.dragItem;
        const event = dropEvent.dragEvent;
