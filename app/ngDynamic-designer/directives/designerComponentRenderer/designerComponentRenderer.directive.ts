...
export class DesignerComponentRendererDirective<TComponent extends DesignerLayoutPlaceholderComponent> implements OnChanges, OnDestroy
{
    ...
    public async ngOnChanges(changes: SimpleChanges)
    {
        ...
        {
            const injector = this.customInjector || this._viewContainerRef.parentInjector;
            const resolved = await ComponentLoader.resolveComponentFactory(this.componentMetadata.designerMetadata.placeholderModule, injector, this.componentMetadata.componentName);
