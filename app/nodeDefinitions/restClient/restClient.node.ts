...
class ɵRestClientNode implements NodeDefinitionGeneric<RestClientNodeOptions>
{
    ...
    private _buildResultObserver(): Observable<any>
    {
        ...
        const body = null;
        const url: string = this.ɵoptions.url;
        const queryString: string = '';
        const queryParams: RestClientNodeParameterValue[] = [];
        ...
        const request = new HttpRequest(RestClientMethodType[this.ɵoptions.method],
                                      url,
                                      body,
                                      {
                                          params
...
@DynamicNodeDesignerMetadata(
{
    relationsMetadata: <RelationsMetadataGeneric<RestClientNodeOptions>>
    {
        ...
        {
            const result: ɵDynamicRelationsInputMetadata[] = [];
