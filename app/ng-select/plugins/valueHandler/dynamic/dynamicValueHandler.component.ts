...
export class DynamicValueHandlerComponent<TValue> implements DynamicValueHandler<TValue>, NgSelectPluginGeneric<DynamicValueHandlerOptions>, OnDestroy
{
    //######################### protected fields #########################
     ...
     */
    protected _options: DynamicValueHandlerOptions;
     ...
     * Options for NgSelect plugin
     */
    public get options(): DynamicValueHandlerOptions
    {
        return this._options;
    }
    public set options(options: DynamicValueHandlerOptions)
    {
    ...
    constructor(@Inject(NG_SELECT_PLUGIN_INSTANCES) @Optional() public ngSelectPlugins: NgSelectPluginInstances,
                ...
                @Inject(VALUE_HANDLER_OPTIONS) @Optional() options?: DynamicValueHandlerOptions)
    {
